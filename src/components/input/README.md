...
[Preview the Input with width-2 class example](http://govuk-frontend-review.herokuapp.com/components/input/with-width-2-class/preview)
...
[Preview the Input with width-3 class example](http://govuk-frontend-review.herokuapp.com/components/input/with-width-3-class/preview)
...
[Preview the Input with width-4 class example](http://govuk-frontend-review.herokuapp.com/components/input/with-width-4-class/preview)
...
[Preview the Input with width-5 class example](http://govuk-frontend-review.herokuapp.com/components/input/with-width-5-class/preview)

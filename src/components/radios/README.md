...
[Preview the Radios with a divider example](http://govuk-frontend-review.herokuapp.com/components/radios/with-a-divider/preview)
...
#### Markup
    ...
    <div class="govuk-form-group">
      ...
      <div class="govuk-radios">
        ...
        <span class="govuk-radios__divider">or</span>
...
<td class="govuk-table__cell ">Optional divider to separate options, e.g "or".</td>
